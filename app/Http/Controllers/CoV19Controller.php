...
class CoV19Controller extends Controller
{
    ...
    public function getResultByArea()
    {
        ...
        return view('cov19.area')->with('result',$result);
    }
    ...
    public function getResultByAge()
    {
        ...
        return view('cov19.age')->with('result',$result);
    }
    ...
    public function getResultByGender()
    {
        ...
        return view('cov19.gender')->with('result',$result)->with('gender',$gender);
    }
    ...
    public function getResultByForeign()
    {
        ...
        return view('cov19.foreign')->with('result',$result);
    }
